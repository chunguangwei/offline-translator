...
object ModelRegistry {
    ...
    val GEMMA4_E2B = ModelInfo(
        ...
        supportsAudio = true,
        maxTokens = 4096,
        urlHf = "https://hf-mirror.com/litert-community/gemma-4-E2B-it-litert-lm/resolve/main/gemma-4-E2B-it.litertlm",
    ...
    val GEMMA4_E4B = ModelInfo(
        ...
        supportsAudio = true,
        maxTokens = 4096,
        urlHf = "https://hf-mirror.com/litert-community/gemma-4-E4B-it-litert-lm/resolve/main/gemma-4-E4B-it.litertlm",
